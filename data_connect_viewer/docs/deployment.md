...
```bash
curl   -H "X-API-Key: changeme"   -H "Content-Type: application/json"   -d '{"hostname":"sv-01","ipaddress":"192.168.0.10","exec_result":"ok"}'   http://127.0.0.1:8000/api/v1/records/default
```
